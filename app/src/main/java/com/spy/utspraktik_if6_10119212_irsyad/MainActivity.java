...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String iNik = "com.spy.utspraktik_if6_10119212_irsyad.nik";
    public static final String iNama = "com.spy.utspraktik_if6_10119212_irsyad.nama";
    public static final String iTl = "com.spy.utspraktik_if6_10119212_irsyad.tl";
    public static final String iJk = "com.spy.utspraktik_if6_10119212_irsyad.jk";
    public static final String iHub = "com.spy.utspraktik_if6_10119212_irsyad.hub";
    ...
    public void selanjutnya(View view) {
        ...
        if(!validate())
            Toast.makeText(getApplicationContext(),  "NIK / Nama tidak boleh kosong", Toast.LENGTH_SHORT).show();
        else {
